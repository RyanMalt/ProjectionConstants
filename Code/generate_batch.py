...
'''
    ...
    cross_training -- states which hyperparameters should be chosen to consider
                        ...
                        to be trained over
    constant_parameters_file -- file holding the default parameters for a model
                                    i.e. the parameters which aren't changing
                                    according to the model.cfg
'''
...
default_model = None
with open(batch_config['constant_parameters_file'], 'r') as f:
