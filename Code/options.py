...
def getArgs():
    ...
    batch_size -- number of data points in each mini-batch (default: 256)
    input_size -- list containing the dimension of R and the dimension of the subspace (default: [4, 2])
    network_layers -- list containing the widths of each hidden layer and the output layer (default: 100 100 1)
    ...
    parser.add_argument('-s', '--batch_size', type=int,
                    default=256, help='number of training points in each mini-batch (default: 256)')
    ...
    parser.add_argument('-n', '--network_layers', nargs='*', type=int,
                    default=[100, 100, 1], help='widths of each hidden layer and the output layer (default: 100 100 1)')
    ...
    parser.add_argument('-d', '--train_points', type=int,
                    default=190000, help='specifies which data files to use for training data (default: 190000)')
